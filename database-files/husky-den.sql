...
('Leo', 'Thomas', 'Computer Science', 'leo.thomas@student.com', 'SmartGreen', 'New York', 1, 1, 1),
('Lily', 'Cruz', 'Business', 'lily.cruz@student.com', 'CloudSphere', 'Los Angeles', 2, 2, 0),
('Ethan', 'Ward', 'Mechanical Engineering', 'ethan.ward@student.com', 'BrightWorks', 'Chicago', 3, 3, 1),
('Zoe', 'Adkins', 'Environmental Science', 'zoe.adkins@student.com', 'NextGen Solutions', 'Austin', 4, 4, 1),
('Victoria', 'Cole', 'Biotechnology', 'victoria.cole@student.com', 'EcoLife', 'San Diego', 5, 5, 0),
('Nathan', 'Baker', 'Civil Engineering', 'nathan.baker@student.com', 'BlueBridge', 'Seattle', 6, 6, 1),
('Chloe', 'Price', 'Finance', 'chloe.price@student.com', 'SolarNova', 'San Francisco', 7, 7, 1),
('Benjamin', 'Carter', 'Data Science', 'benjamin.carter@student.com', 'AlphaGrowth', 'Boston', 8, 8, 1),
('Sophia', 'Flores', 'Marketing', 'sophia.flores@student.com', 'GreenFuture', 'Houston', 9, 9, 0),
('James', 'Brooks', 'Electrical Engineering', 'james.brooks@student.com', 'BrightEnergy', 'Phoenix', 10, 10, 0),
('Scarlett', 'Powell', 'Information Technology', 'scarlett.powell@student.com', 'EcoVision', 'Philadelphia', 11, 11, 1),
('Charlotte', 'Morris', 'Physics', 'charlotte.morris@student.com', 'NextStep', 'Miami', 12, 12, 0),
('Avery', 'Diaz', 'Computer Engineering', 'avery.diaz@student.com', 'ProGrowth', 'Portland', 13, 13, 1),
('Liam', 'Rogers', 'Software Engineering', 'liam.rogers@student.com', 'GreenNet', 'Atlanta', 14, 14, 0),
('Noah', 'Alexander', 'Mathematics', 'noah.alexander@student.com', 'VisionaryTech', 'New York', 15, 15, 0),
('Eleanor', 'Hayes', 'Environmental Engineering', 'eleanor.hayes@student.com', 'EcoWorld', 'Dallas', 16, 16, 1),
('Grace', 'Jenkins', 'Economics', 'grace.jenkins@student.com', 'PureSolutions', 'Baltimore', 17, 17, 1),
('Isaac', 'Howard', 'Chemical Engineering', 'isaac.howard@student.com', 'BrightStart', 'San Jose', 18, 18, 0),
('Emma', 'Hill', 'Health Sciences', 'emma.hill@student.com', 'SolarEdge', 'Charlotte', 19, 19, 0),
('Alexander', 'Kelly', 'Robotics', 'alexander.kelly@student.com', 'NextEra', 'Indianapolis', 20, 20, 1),
('Isabella', 'Watson', 'Astrophysics', 'isabella.watson@student.com', 'BrightHorizons', 'Kansas City', 21, 21, 1),
('Aiden', 'Long', 'Cybersecurity', 'aiden.long@student.com', 'FutureNet', 'Columbus', 22, 22, 1),
('Liam', 'Stewart', 'Sociology', 'liam.stewart@student.com', 'SolarBridge', 'Milwaukee', 23, 23, 1),
('Olivia', 'Rivera', 'Accounting', 'olivia.rivera@student.com', 'BrightTech', 'Salt Lake City', 24, 24, 0),
('Lucas', 'Cook', 'Art and Design', 'lucas.cook@student.com', 'GreenWave', 'Orlando', 25, 25, 1),
('Sophia', 'Bell', 'Geology', 'sophia.bell@student.com', 'NextWave', 'Tampa', 26, 26, 1),
('Evelyn', 'Murphy', 'Anthropology', 'evelyn.murphy@student.com', 'AlphaNet', 'Minneapolis', 27, 27, 0),
('Mason', 'Griffin', 'Statistics', 'mason.griffin@student.com', 'BrightFuture', 'Pittsburgh', 28, 28, 0),
('Chloe', 'Sanders', 'Education', 'chloe.sanders@student.com', 'SolarWorks', 'Raleigh', 29, 29, 0),
('Zachary', 'Russell', 'Mechanical Engineering', 'zachary.russell@student.com', 'GreenEdge', 'Cleveland', 30, 30, 0),
('Samantha', 'Foster', 'Psychology', 'samantha.foster@student.com', 'FuturePath', 'Richmond', 1, 31, 1),
('Nathan', 'Parker', 'Urban Planning', 'nathan.parker@student.com', 'NextGrid', 'Anchorage', 2, 32, 1),
('Ella', 'Bennett', 'Graphic Design', 'ella.bennett@student.com', 'ProSolutions', 'Boise', 3, 33, 1),
('William', 'Ross', 'International Relations', 'william.ross@student.com', 'EcoStart', 'Augusta', 4, 34, 1),
('Scarlett', 'Reed', 'Agriculture', 'scarlett.reed@student.com', 'VisionNova', 'Reno', 5, 35, 0),
('Benjamin', 'Walker', 'Biomedical Engineering', 'benjamin.walker@student.com', 'BrightSystems', 'Shreveport', 6, 36, 1),
('Charlotte', 'Gonzalez', 'Political Science', 'charlotte.gonzalez@student.com', 'GreenCore', 'Trenton', 7, 37, 0),
('Ethan', 'Lopez', 'Environmental Science', 'ethan.lopez@student.com', 'FutureWave', 'Madison', 8, 38, 1),
('Avery', 'Edwards', 'Public Health', 'avery.edwards@student.com', 'ProEdge', 'Fort Worth', 9, 39, 0),
('Nathan', 'Rogers', 'Social Work', 'nathan.rogers@student.com', 'GreenWorks', 'Wichita', 10, 40, 1),
('Ella', 'Mitchell', 'Industrial Design', 'ella.mitchell@student.com', 'NextGen', 'Oklahoma City', 11, 1, 0),
('Alexander', 'Phillips', 'Economics', 'alexander.phillips@student.com', 'BrightIdeas', 'San Antonio', 12, 2, 0),
('Victoria', 'Morgan', 'Chemical Engineering', 'victoria.morgan@student.com', 'GreenHorizons', 'Denver', 13, 3, 0),
('Lucas', 'Watson', 'Physics', 'lucas.watson@student.com', 'FuturePath', 'Seattle', 14, 4, 1),
('Isabella', 'Brooks', 'Data Analytics', 'isabella.brooks@student.com', 'BrightTech', 'Salt Lake City', 15, 5, 0),
('Jessica', 'Johnson', 'History', 'jessica.johnson@student.com', 'Innovate Ltd', 'Boston', 2, 2, 0),
('Emily', 'Brown', 'Education', 'emily.brown@student.com', 'DataSoft', 'San Francisco', 3, 3, 0),
('Matthew', 'Williams', 'Cybersecurity', 'matthew.williams@student.com', 'GreenTech', 'Seattle', 4, 4, 0),
('Daniel', 'Jones', 'Energy Systems', 'daniel.jones@student.com', 'EcoEnergy', 'Chicago', 5, 5, 1),
('Sarah', 'Garcia', 'Environmental Science', 'sarah.garcia@student.com', 'NextGen Inc', 'Austin', 6, 6, 0),
('Ashley', 'Martinez', 'Computer Science', 'ashley.martinez@student.com', 'WebWare', 'Dallas', 7, 7, 0),
('Christopher', 'Rodriguez', 'Mechanical Engineering', 'chris.rodriguez@student.com', 'BuildRight', 'Denver', 8, 8, 1),
('Amanda', 'Davis', 'Health Sciences', 'amanda.davis@student.com', 'BlueOcean', 'Los Angeles', 9, 9, 1),
('David', 'Hernandez', 'Physics', 'david.hernandez@student.com', 'AlphaBio', 'Miami', 10, 10, 1),
('Andrew', 'Moore', 'Political Science', 'andrew.moore@student.com', 'SkyWorks', 'Phoenix', 11, 11, 1),
('Elizabeth', 'Taylor', 'Mathematics', 'elizabeth.taylor@student.com', 'CloudSync', 'Houston', 12, 12, 1),
('James', 'Anderson', 'Sociology', 'james.anderson@student.com', 'ProNet', 'San Diego', 13, 13, 1),
('Megan', 'Thomas', 'Nursing', 'megan.thomas@student.com', 'AgriMax', 'Atlanta', 14, 14, 0),
('Joshua', 'Jackson', 'Civil Engineering', 'joshua.jackson@student.com', 'TechWave', 'Orlando', 15, 15, 0),
('Lauren', 'White', 'Environmental Science', 'lauren.white@student.com', 'FutureEdge', 'Pittsburgh', 16, 16, 1),
('Ryan', 'Harris', 'Biology', 'ryan.harris@student.com', 'EcoSolutions', 'Columbus', 17, 17, 1),
('Sophia', 'Martin', 'Astronomy', 'sophia.martin@student.com', 'NextPhase', 'Salt Lake City', 18, 18, 1),
('Jacob', 'Thompson', 'Economics', 'jacob.thompson@student.com', 'SolarSync', 'Tampa', 19, 19, 0),
('Anna', 'Lopez', 'Statistics', 'anna.lopez@student.com', 'BrightPath', 'Nashville', 20, 20, 0),
('Jonathan', 'Clark', 'Philosophy', 'jonathan.clark@student.com', 'UrbanGrid', 'Baltimore', 21, 21, 1),
('Victoria', 'Lee', 'Journalism', 'victoria.lee@student.com', 'GreenField', 'Minneapolis', 22, 22, 1),
('Ethan', 'Walker', 'Graphic Design', 'ethan.walker@student.com', 'TechNova', 'Portland', 23, 23, 0),
('Isabella', 'Hall', 'Social Sciences', 'isabella.hall@student.com', 'AquaVantage', 'Raleigh', 24, 24, 0),
('Christopher', 'Allen', 'Urban Studies', 'chris.allen@student.com', 'PureTech', 'Kansas City', 25, 25, 0),
('Abigail', 'Young', 'Liberal Arts', 'abigail.young@student.com', 'BioWare', 'Indianapolis', 26, 26, 1),
('Alexander', 'King', 'Engineering', 'alex.king@student.com', 'SmartHomes', 'Milwaukee', 27, 27, 1),
('Grace', 'Wright', 'Chemistry', 'grace.wright@student.com', 'SecureNet', 'Sacramento', 28, 28, 0),
('Lucas', 'Scott', 'Business Analytics', 'lucas.scott@student.com', 'VisionTech', 'Charlotte', 29, 29, 1),
('Olivia', 'Green', 'Marketing', 'olivia.green@student.com', 'AgriGen', 'Omaha', 30, 30, 0),
('Nathan', 'Hill', 'Psychology', 'nathan.hill@student.com', 'HealthSync', 'Cleveland', 1, 31, 0),
('Emma', 'Adams', 'Physics', 'emma.adams@student.com', 'CodeWave', 'Richmond', 2, 32, 1),
('Zoe', 'Nelson', 'Public Relations', 'zoe.nelson@student.com', 'SmartEnergy', 'Anchorage', 3, 33, 1),
('Michael', 'Carter', 'Energy Systems', 'michael.carter@student.com', 'BrightTech', 'Boise', 4, 34, 1),
('Sophia', 'Mitchell', 'Environmental Science', 'sophia.mitchell@student.com', 'EcoGrow', 'Montgomery', 5, 35, 1),
('James', 'Perez', 'Engineering Management', 'james.perez@student.com', 'GeoSystems', 'Albuquerque', 6, 36, 0),
('Lily', 'Roberts', 'Cybersecurity', 'lily.roberts@student.com', 'FutureLink', 'Charleston', 7, 37, 0),
('Benjamin', 'Evans', 'Urban Studies', 'benjamin.evans@student.com', 'VisionEdge', 'Hartford', 8, 38, 0),
('Ella', 'Lewis', 'Political Science', 'ella.lewis@student.com', 'AutoTech', 'Des Moines', 9, 39, 1),
('William', 'Collins', 'Computer Science', 'william.collins@student.com', 'SolarEdge', 'Little Rock', 10, 40, 0);
